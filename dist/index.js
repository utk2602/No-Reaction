...
var projectNameBase = path.basename(projectPath);
var isCurrentDirectory = projectPath === process.cwd();
if (import_fs_extra.default.existsSync(projectPath)) {
  if (isCurrentDirectory) {
    const files = import_fs_extra.default.readdirSync(projectPath);
    if (files.length > 0) {
      console.warn(`
...
var templateDir = path.resolve(__dirname2, "../template");
